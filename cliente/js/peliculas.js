    ...
    this.buscarPeliculas = function(pagina, cantidad) {
            ...
            $.getJSON(servidor + "/peliculas?" + query,
                function(data) {
                    ...
                    self.cargarBotones(data.total, pagina_solicitada - 1); //self.cargarBotones(data.total); -- Solucion Agustin
                });
        },
        ...
        this.cargarBotones = function(total, paginaSolicitada) { //this.cargarBotones = function(total) { --Solucion Agustin
            ...
            for (i = 0; i < cantidad_paginas; i++) {
                ...
                boton.show();
                if (i == paginaSolicitada) boton.addClass("active");
            }
